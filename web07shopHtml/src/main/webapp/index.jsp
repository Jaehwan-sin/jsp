...
<body>
    <div id="wrap">
        <header>
            <div id="login"><a href="../d22mission/loginform2.html">login</a> | <a href="#">join</a></div>
            <!-- clear는 간섭을 배제한다. -->
            <div class="clear"></div>
            <div id="logo">
                <img src="./images/logo5.png" alt="nike" width="265" height="62">
            </div>
            <nav id="top_menu">
                <ul>
        ...
        <div class="clear"></div>
        <!-- <div id="main_img">
            <img src="./images/img5.png" alt="" width="971" height="282">
        </div>
        jquery를 이용한 메인이미지 넣기 -->
        <div id="main_img">
            ...
            <div id="s3slider">
                <ul id="s3sliderContent">
                    <li class="s3sliderImage">
                        <img src="./images/img5.png" width="971" height="282">
                        <span>
                            로렘 ipsum dolor sit amet, consecteur adipiscing elit. Nullam semper eratest<br>
                            Aloiquam metus elit, blandit eu luctus vitae, dictum ist amet mauris. Integerut facilisis
                            eros<br>
